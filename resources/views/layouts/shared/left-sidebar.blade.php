...
<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="{{ route('any', 'category') }}" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="{{ route('any', 'sales') }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
            ...
            <li class="side-nav-item">
                <a href="{{ route('second', ['product', 'add']) }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
            ...
            <li class="side-nav-item">
                <a href="{{ route('second', ['product', 'list']) }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
            ...
            <li class="side-nav-item">
                <a href="{{ route('any', 'client') }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
                    <span> Client </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="{{ route('second', ['system', 'register']) }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
            ...
            <li class="side-nav-item">
                <a href="{{ route('second', ['system', 'settings']) }}" class="side-nav-link">
                    <i class="ri-stack-fill"></i>
                    <span> Settings </span>
                </a>
            </li>
